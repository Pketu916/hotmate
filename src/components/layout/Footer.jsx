    ...
    <footer className="bg-[var(--bg-dark)] text-white pt-16 md:pt-20 pb-8 md:pb-10">
      <div className="container px-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              The future of warm meals. Advanced temperature-setting lunchbox
              that keeps your food fresh and warm throughout the day.
            </p>
            {/* Social Media Links */}
            <div>
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:text-white hover:bg-orange-500 transition-all duration-300 focus:outline-none"
                  aria-label="Facebook"
                >
                  <svg
                    className="w-5 h-5"
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>
            &copy; {currentYear} Hotmate. All rights reserved. | The future of
            warm meals.
          </p>
        </div>
      </div>
